...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [31 x i8] c"com.companyname.theantilistapp\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [29 x i8] c"libaot-TheAntiListApp.dll.so\00", align 1
