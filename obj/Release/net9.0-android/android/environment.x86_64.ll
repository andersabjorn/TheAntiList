...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x37bdf9f747999d34, ; from name: aot-TheAntiListApp.dll.so
		i64 u0xd73b769fda731bc6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TheAntiListApp.dll.so
		ptr null; void* handle
	}, ; 156
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x560891d1bd87b4c4, ; from name: TheAntiListApp
		i64 u0xd73b769fda731bc6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TheAntiListApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x5e66f65d8ad31dab, ; from name: TheAntiListApp.so
		i64 u0xd73b769fda731bc6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TheAntiListApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xae9c42d642083757, ; from name: TheAntiListApp.dll.so
		i64 u0xd73b769fda731bc6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TheAntiListApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xaebb59558d915769, ; from name: libaot-TheAntiListApp
		i64 u0xd73b769fda731bc6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TheAntiListApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd73b769fda731bc6, ; from name: libaot-TheAntiListApp.dll.so
		i64 u0xd73b769fda731bc6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TheAntiListApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd9f1945256d02bec, ; from name: libaot-TheAntiListApp.so
		i64 u0xd73b769fda731bc6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TheAntiListApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xdd8147c16a05aefc, ; from name: aot-TheAntiListApp
		i64 u0xd73b769fda731bc6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TheAntiListApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xec077deb90e3e354, ; from name: aot-TheAntiListApp.so
		i64 u0xd73b769fda731bc6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TheAntiListApp.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [31 x i8] c"com.companyname.theantilistapp\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [29 x i8] c"libaot-TheAntiListApp.dll.so\00", align 16
